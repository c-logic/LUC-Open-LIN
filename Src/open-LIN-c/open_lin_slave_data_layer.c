...
static l_bool open_lin_slave_set_lin_frame(t_open_lin_data_layer_frame *frame){
	...
	if (frame_slot != OPEN_LIN_NET_SLOT_EMPTY)
	{
		...
		frame->checksumtype = frame_slot->checksum_type;
		...
		switch (open_lin_slave_state){
			...
			case (OPEN_LIN_SLAVE_PID_RX):
			{
				...
				if (open_lin_slave_set_lin_frame(&open_lin_data_layer_frame) == true)
				{
					...
					{
						open_lin_data_layer_frame.checksum = open_lin_data_layer_checksum(open_lin_data_layer_frame.pid, open_lin_data_layer_frame.lenght, open_lin_data_layer_frame.data_ptr, open_lin_data_layer_frame.checksumtype);
			...
			case (OPEN_LIN_SLAVE_DATA_RX):
			{
				...
				} else
				{
					...
					if (rx_byte == open_lin_data_layer_checksum(open_lin_data_layer_frame.pid, open_lin_data_layer_frame.lenght, open_lin_slave_data_buff, open_lin_data_layer_frame.checksumtype))
					{
