...
typedef struct {
	...
	l_u8 lenght;
	l_u8* data_ptr;
	open_lin_checksum_type_t checksumtype;
...
extern open_lin_checksum_t open_lin_data_layer_checksum(open_lin_pid_t pid, l_u8 lenght,const l_u8* data_ptr, open_lin_checksum_type_t cs_type);
